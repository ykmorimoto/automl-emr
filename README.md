...
While a machine learning(ML) project requires iterative proceses from understanding data to tuning model parameters in order to develop a optimal model for data, some tasks in the analysis process can be automated. Automl EMR implements functions to accelerate the process of developing the ML model.
